...
rD <- rsDriver(browser="chrome", port=as.integer(l), verbose=F, chromever = "103.0.5060.53") # Changer de port à chaque run
...
saveRDS(data, paste0("Intermediate/scraps/to_add", paste0(j, "-", k),'.rds'))
