...
# entrfiltr_siren_2016 <- entrfiltr_siren %>% filter(annee_base==2016)
# entrfiltr_siren_2017 <- entrfiltr_siren %>% filter(annee_base==2017)
entrfiltr_siren_2018 <- entrfiltr_siren %>% filter(annee_base==2018)
entrfiltr_siren_2019 <- entrfiltr_siren %>% filter(annee_base==2019)
entrfiltr_siren_2020 <- entrfiltr_siren %>% filter(annee_base==2020)
entrfiltr_siren_2021 <- entrfiltr_siren %>% filter(annee_base==2021)
entrfiltr_siren_2022 <- entrfiltr_siren %>% filter(annee_base==2022)
...
se_2018 <-  fread("Raw/INSEE/2018-12-01-StockEtablissement_utf8/StockEtablissement_utf8.csv", 
  ...
  filter(
    siren %in% entrfiltr_siren_2018$siren
  )
...
se_2019 <- fread("Raw/INSEE/2019-12-01-StockEtablissement_utf8/StockEtablissement_utf8.csv", 
  ...
  filter(
    siren %in% entrfiltr_siren_2019$siren
  )
...
se_2020 <- fread("Raw/INSEE/2020-12-01-StockEtablissement_utf8/StockEtablissement_utf8.csv", 
  ...
  filter(
    siren %in% entrfiltr_siren_2020$siren
  )
...
se_2021 <- fread("Raw/INSEE/2021-09-01-StockEtablissement_utf8/StockEtablissement_utf8.csv", 
  ...
  filter(
    siren %in% entrfiltr_siren_2021$siren
  )
...
se_2022 <- fread("Raw/INSEE/2022-07-01-StockEtablissement_utf8/StockEtablissement_utf8.csv", 
  ...
  filter(
    siren %in% entrfiltr_siren_2022$siren
  )
